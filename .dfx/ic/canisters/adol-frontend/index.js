...
import { idlFactory } from './adol-frontend.did.js';
export { idlFactory } from './adol-frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ADOL_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./adol-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the adol-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./adol-frontend.did.js")._SERVICE>}
 */
export const adol_frontend = createActor(canisterId);
