...
import { ArrowRight, Check, Star, MessageCircle, Zap, Shield, Users, CircleArrowRight, WandSparkles, Package, CircleCheckBig, Fingerprint, ChevronUp, ChevronDown, Box } from 'lucide-react';
  ...
  const faqData: FAQItem[] = [
    {
      ...
      answer: "No, our AI agent handles all buyer communications for you automatically."
    },
    {
    ...
    },
    {
      ...
      answer: "Addi posts to multiple popular marketplaces including Facebook Marketplace, Craigslist, and other local selling platforms."
    },
    {
      question: "How long does it take for my item to be listed?",
      answer: "Most items are listed within 24 hours of activation. Our AI processes your item details and creates optimized listings quickly."
    },
    {
      question: "Can I edit my listing after it's live?",
      answer: "Yes, you can make changes to your listing at any time through your dashboard. Updates are automatically synced across all platforms."
    },
    {
      question: "Is there a limit to how many items I can list?",
      answer: "There's no hard limit, but you'll need sufficient credits for each item activation. Bulk listing discounts are available."
    }
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(180deg, rgba(255,255,255,0.85) 0%, rgba(255,255,255,0.3) 30%, rgba(255,255,255,0.3) 60%, rgba(255,255,255,1) 100%)'
          }}
        ></div>
        ...
        <div className="relative z-10">
          ...
          <nav className="px-4 sm:px-6 py-4 flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-6">
              <a href="#" className="text-black hover:text-gray-900 font-semibold">Features</a>
              <a href="#" className="text-black hover:text-gray-900 font-semibold">Pricing</a>
              <a href="#" className="text-black hover:text-gray-900 font-semibold">About</a>
            </div>
            ...
            {/* Get Started Button */}
              <button
                className="text-white px-3 sm:px-4 py-2 rounded-full flex items-center justify-center gap-1 transition-all hover:shadow-lg text-xs sm:text-sm"
                style={{
                  background: 'linear-gradient(180deg, #323232 0%, #0A0A0A 100%)',
                  boxShadow: '0 1px 0 0 rgba(255, 255, 255, 0.33) inset, 0 -2px 2px 0 rgba(255, 255, 255, 0.10) inset, 0 0 0 1.5px #000, 0 3px 4px -1px rgba(0, 0, 0, 0.25)',
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 md:pt-16 pb-0">
            ...
            <p className="text-base sm:text-lg md:text-xl text-neutral-400 mb-6 sm:mb-8 max-w-2xl mx-auto px-4 sm:px-0">
              The easiest way to sell your stuff. Take a photo, let our AI do the work, and get paid fast.
            </p>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-8 sm:mb-12 px-4 sm:px-0">
              <button
                className="flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-2 rounded-full font-semibold text-white text-sm sm:text-base
...
transition-colors w-full sm:w-auto"
              ...
              <button className="flex items-center justify-center gap-2 border border-gray-300 text-gray-700 px-6 sm:px-8 py-3 rounded-full shadow-md font-semibold hover:border-gray-400 transition-colors text-sm sm:text-base w-full sm:w-auto">
      ...
      <section className="px-6 py-20">
        <div className="max-w-[600px] mx-auto text-center">
          <h2 className="text-4xl font-normal text-black mb-2">Why sell the hard way?</h2>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="rounded-3xl bg-yellow-100 shadow-sm flex flex-col h-fit">
                <div className="m-5 text-left">
                  <h3 className="font-bold text-xl mb-2 text-yellow-900">Snap & Go</h3>
              ...
              <div className="rounded-3xl bg-indigo-100 shadow-sm flex flex-col h-[310px] relative">
                <div className="m-5 text-left">
                  ...
                  <p className="text-indigo-700 text-sm leading-relaxed">
                    Adol chats with buyers, filters low-ballers, and brings only serious offers.
                  </p>
                </div>
              ...
              <div className="rounded-3xl bg-rose-100 shadow-sm flex flex-col h-[320px] relative">
                <div className="m-5 text-left">
                  ...
                  <p className="text-rose-900 text-sm leading-relaxed">
                    Smart titles, catchy descriptions, and market-based pricing — done for you.
                  </p>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col gap-3 mt-3 justify-center items-center">
                <p
                  className="flex w-8 h-8 flex-col justify-center items-center gap-2 rounded-full bg-gradient-to-b from-[#7C86FF] to-[#615FFF] text-white text-sm font-semibold"
                >
                  1
                </p>
                <div className="mt-3">
                  <h3 className="text-xl font-normal mb-2 text-black">Snap it</h3>
                  <p className="text-neutral-400">
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col gap-3 mt-3 justify-center items-center">
                ...
                <div className="mt-3">
                  <h3 className="text-xl font-normal mb-2 text-black">Adol works its magic</h3>
                  <p className="text-neutral-400">
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col gap-3 mt-3 justify-center items-center">
                ...
                <div className="mt-3">
                  <h3 className="text-xl font-normal mb-2 text-black">Get paid, stress-free</h3>
                  <p className="text-neutral-400">
                    Approve the best offer, and let Adol handle all negotiations.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="px-30 py-20 mx-auto bg-black rounded-[40px]">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="flex-shrink-0">
              <Image src="/assets/images/ai-icp.png" width={700} height={500} alt="icp" />
            </div>

            {/* Bagian kanan: Konten */}
            <div className="flex-1">
              <h2 className="text-4xl font-normal mb-3">Powered by ICP</h2>
              <p className="text-gray-400 mb-10">Simple, transparent, Web3-powered.</p>

              <div className="flex flex-col gap-4 mb-10">
                <div className="bg-gray-900 rounded-xl py-3 px-5 flex items-start gap-3">
                  <span><CircleCheckBig size={20} /></span>
                  <p>Top up with ICP, your digital credits fuel your AI agent.</p>
                </div>
                <div className="bg-gray-900 rounded-xl py-3 px-5 flex items-start gap-3">
                  <span><CircleCheckBig size={20} /></span>
        ...
        <div className="mx-auto w-full">
          <div className="text-center mb-16">
            <div className="relative inline-block mb-4">
              <h2 className="text-5xl font-normal text-black">Stay in the loop</h2>
              <span className="absolute -top-4 -right-8 text-blue-500 italic text-lg font-medium transform rotate-12" style={{ fontFamily: 'Figma Hand' }}>only when it matters</span>
            </div>
            ...
            <div className="flex justify-center items-center gap-8 mb-4">
              ...
              <div className="flex items-center">
                ...
                <div className="flex items-center bg-purple-500 text-white px-6 py-3 rounded-full shadow-lg">
                  <span className="text-sm font-medium">Draft listing ready — approve & post.</span>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="flex items-center bg-red-500 text-white px-6 py-3 rounded-full shadow-lg">
                  <span className="text-sm font-medium">Buyer’s final offer Rp 1,650,000 — deal?</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center items-center gap-8 mb-4">
              ...
              <div className="flex items-center w-full">
                ...
                <div className="flex items-center bg-orange-500 text-white px-6 py-3 rounded-full shadow-lg">
                  <span className="text-sm font-medium">Low credits — top up to keep selling.</span>
                </div>
              </div>
              ...
              <div className="flex items-center w-full">
                ...
                <div className="flex items-center bg-green-500 text-white px-6 py-3 rounded-full shadow-lg">
                  <span className="text-sm font-medium">Item shipped — tracking number sent.</span>
                </div>
              </div>
              ...
              <div className="flex items-center w-full">
                ...
                <div className="flex items-center bg-pink-500 text-white px-6 py-3 rounded-full shadow-lg">
                  <span className="text-sm font-medium">New inquiries received — respond promptly.</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center items-center gap-8">
              ...
              <div className="flex items-center">
                ...
                <div className="flex items-center bg-indigo-700 text-white px-6 py-3 rounded-full shadow-lg">
                  <span className="text-sm font-medium">Reminder: Feedback request pending — follow up!</span>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="flex items-center bg-cyan-500 text-white px-6 py-3 rounded-full shadow-lg">
                  <span className="text-sm font-medium">Pickup scheduled for Saturday — confirm?</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="px-6 py-20 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-normal text-center mb-4 text-black">Loved by amazing sellers everywhere</h2>
            <p className="text-neutral-400 text-lg">From decluttering to quick cash — see what our users say.</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="space-y-6">
              <div className="bg-white shadow-lg border border-gray-200 p-6 rounded-xl">
                <p className="text-gray-700 mb-4">"I sold my headphones in just a day— without any effort on my part. Addi has become my go-to partner for side hustling."</p>
                <p className="text-gray-400 text-sm">Sarah</p>
              </div>

              <div className="bg-white shadow-lg border border-gray-200 p-6 rounded-xl">
                <p className="text-gray-700 mb-4">"I turned my cooking skills into cash. Addi connected me with eager buyers in no time!"</p>
                <p className="text-gray-400 text-sm">Mark</p>
              </div>

              <div className="bg-white shadow-lg border border-gray-200 p-6 rounded-xl">
                <p className="text-gray-700 mb-4">"Addi organized a successful garage sale for my unwanted items, making it so easy."</p>
            ...
            <div className="space-y-6">
              <div className="bg-white shadow-lg border border-gray-200 p-6 rounded-xl">
                <p className="text-gray-700 mb-4">"Addi helped me find a new home for my bike; the entire process was seamless."</p>
                <p className="text-gray-400 text-sm">Jake</p>
              </div>

              <div className="bg-white shadow-lg border border-gray-200 p-6 rounded-xl">
                <p className="text-gray-700 mb-4">"I decluttered my apartment before moving and Addi took care of everything for me."</p>
                <p className="text-gray-400 text-sm">Daisy</p>
              </div>

              <div className="bg-white shadow-lg border border-gray-200 p-6 rounded-xl">
                <p className="text-gray-700 mb-4">"Selling my handcrafted jewelry was a breeze with Addi, and I reached a larger audience than ever before."</p>
                <p className="text-gray-400 text-sm">Sophie</p>
              </div>

              <div className="bg-white shadow-lg border border-gray-200 p-6 rounded-xl">
                <p className="text-gray-700 mb-4">"Transformed my handmade crafts into a thriving online shop with Addi's support."</p>
            ...
            <div className="space-y-6">
              <div className="bg-white shadow-lg border border-gray-200 p-6 rounded-xl">
                <p className="text-gray-700 mb-4">"I effortlessly sold my vintage vinyl collection, all thanks to Addi's fantastic online marketplace."</p>
                <p className="text-gray-400 text-sm">Emma</p>
              </div>

              <div className="bg-white shadow-lg border border-gray-200 p-6 rounded-xl">
                <p className="text-gray-700 mb-4">"I successfully listed and sold my old sports equipment, thanks to Addi's easy-to-use interface."</p>
                <p className="text-gray-400 text-sm">Carlos</p>
              </div>

              <div className="bg-white shadow-lg border border-gray-200 p-6 rounded-xl">
                <p className="text-gray-700 mb-4">"I cleared out my closet and made some extra cash, all thanks to Addi's user-friendly platform."</p>
      ...
      <section className="px-6 py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-normal text-black mb-4">Simple pricing. Zero surprises.</h2>
            <p className="text-neutral-400 text-lg">Pay with Addi Credits. If you don't sell, you don't lose big.</p>
          </div>
          ...
          <div className="flex flex-col items-center space-y-4 max-w-2xl mx-auto">
            ...
            <div className="bg-green-100 px-8 py-4 rounded-[20px] border-2 border-dashed border-green-500 shadow-md transform rotate-4 w-full max-w-md">
              <p className="text-black font-medium text-center">
                <span className="font-bold">Agent Activation Fee:</span> 10 credits per item.
              </p>
            </div>
            ...
            <div className="bg-yellow-100 px-8 py-4 border-2 border-dashed border-yellow-500 rounded-[20px] shadow-md -mt-3 transform -rotate-2 w-full max-w-lg z-5">
              <p className="text-black font-medium text-center">
                <span className="font-bold">Sales Commission:</span> Small % after successful sale.
              </p>
            </div>
            ...
            <div className="bg-purple-100 px-8 py-4 rounded-[20px] border-2 border-dashed border-purple-500 shadow-md transform rotate-2 -mt-5 w-full max-w-2xl z-10">
              <p className="text-black font-medium text-center">
                <span className="font-bold">Fee-to-Commission Rebate:</span> Activation fee deducted from final commission.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-6 py-20 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            {/* Left side - Header */}
            <div>
              <h2 className="text-5xl font-normal text-black mb-4">Got questions?</h2>
            ...
            <div className="space-y-4">
              {faqData.map((faq, index) => (
                <div key={index} className={`${openIndex === index && "bg-indigo-50 border-2 border-dashed border-indigo-300 rounded-[20px]"} overflow-hidden`}>
                  <button
          ...
          >
            ...
            <div className="relative z-10 text-center px-6 py-12">
              ...
              <p className="text-neutral-400 text-sm mb-8 max-w-md mx-auto">
                Activate your AI sales agent today — make selling easier than buying.
              </p>
              <button
                ...
                style={{
                  ...
                  boxShadow: '0 1px 0 0 rgba(255, 255, 255, 0.33) inset, 0 -2px 2px 0 rgba(10, 10, 10, 0.10) inset, 0 0 0 1.5px #432DD7, 0 3px 4px -1px rgba(0, 0, 0, 0.25)'
                }}
              >
                <Box size={20} />
      ...
      <footer className="bg-white text-white px-4 py-20 sm:py-28 md:py-50 relative overflow-hidden mt-10 w-full">
        ...
        <div
          className="absolute inset-0 z-0"
          style={{
            background: 'linear-gradient(to bottom, rgba(255, 255, 255, 0.9) 0%, rgba(255, 255, 255, 0.6) 40%, rgba(255, 255, 255, 0.2) 80%, rgba(255, 255, 255, 0.05) 100%)'
          }}
        ></div>
